package in.vnurture.myapplication.Services;
...
import in.vnurture.myapplication.Config;
import in.vnurture.myapplication.FirebaseAuthActivity;
import in.vnurture.myapplication.NotiUtil;
    ...
    private void handleDataMessage(JSONObject json) {
        ...
        try {
            ...
            if (!NotiUtil.isAppIsInBackground(getApplicationContext())) {
                ...
                Intent resultIntent = new Intent(getApplicationContext(), FirebaseAuthActivity.class);
